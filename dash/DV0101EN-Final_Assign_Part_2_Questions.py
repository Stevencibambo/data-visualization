...
app.layout = html.Div([
    ...
    html.Div([
         html.Div(id='output-container', className='chart-grid', style={"displayed": "flex"}),
    ])
])
...
def update_output_container(input_year, selected_statistics):
    if selected_statistics == 'Recession Period Statistics':
        ...
        period = data[data['Year'] == input_year]
        ...
        R_chart1 = dcc.Graph(figure=px.bar(yearly_rec, x='Year', y='Automobile_Sales',
        ...
        employment = recession_data.groupby("Vehicle_Type")['unemployment_rate'].mean().reset_index()
        R_chart4 = dcc.Graph(figure=px.bar(employment, x='Vehicle_Type', y='unemployment_rate',
    ...
    # Yearly Statistic Report Plots
        ...
        exp_data = yearly_data.groupby("Vehicle_Type")["Advertising_Expenditure"].mean()
        Y_chart4 = dcc.Graph(figure=px.bar(data_frame=exp_data, x="Advertising_Expenditure",
